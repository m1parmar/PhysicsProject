 ...
 * @author Mahit
 */
public class electricityQuestionThree extends javax.swing.JFrame {

    /**
     * Creates new form electricityQuestionThree
     */
    public electricityQuestionThree() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtFinal3E = new javax.swing.JTextField();
        ...
        txtRough3E = new javax.swing.JTextArea();
        ...
        txtFinal3E.setBackground(new java.awt.Color(255, 102, 102));
        txtFinal3E.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(txtFinal3E, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 270, 100, 40));
        ...
        jLabel7.setText("of 120V and a 20A fuse?");
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1, -1));

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("What is the maximum power that may be used in a circuit with a potential difference");
        ...
        txtRough3E.setBackground(new java.awt.Color(255, 102, 102));
        txtRough3E.setColumns(20);
        txtRough3E.setRows(5);
        jScrollPane1.setViewportView(txtRough3E);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 148, 360, 90));
        ...
        setBounds(0, 0, 517, 429);
    }// </editor-fold>//GEN-END:initComponents

    private void btnCalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculateActionPerformed
        // TODO add your handling code here:
        String electricityAnswer3 = txtFinal3E.getText();

        if (electricityAnswer3.equals(data.electricityThree)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(electricityQuestionThree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new electricityQuestionThree().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtFinal3E;
    private javax.swing.JTextArea txtRough3E;
